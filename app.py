...
def index():
    ...
    try:
        ...
        g = g.astype(int)
        month = ['Dec-2010', 'Jan-2011', 'Feb-2011', 'Mar-2011', 'Apr-2011', 'May-2011','Jun-2011', 'Jul-2011', 'Aug-2011', 'Sep-2011', 'Oct-2011', 'Nov-2011','Dec-2011']
        value = g.iloc[0,:]
        value = value.values
        values = []
        for i in value:
        ...
        return render_template("index.html", x = r, purchase=purchase, id = x, headings = purchase_col, data = purchase_value,
                               ...
                               qurt_head = qurt_col, qurt_data = qurt_val, y = y, labels = month, values = values )
    except:
        return render_template("back.html")
